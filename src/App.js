...
import OngoingOrders from './componenents/orders/ongoing';
import HistoryOrders from './componenents/history/history';
      ...
      <Router>
        <Context>
          <React.Fragment>
            ...
            <PrivateRoute path="/orders" componenent={OngoingOrders} />
            <PrivateRoute path="/history" componenent={HistoryOrders} />
